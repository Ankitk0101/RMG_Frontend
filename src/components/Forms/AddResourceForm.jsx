      ...
      columns: [
        ...
        [
          ...
          { 
            ...
            options: ['', '9AM - 6PM', '10AM - 7PM', 'Flexible', 'Shift', 'Night Shift'],
            required: true
          },
        ],
        [
      ...
      columns: [
        [
          { 
            ...
            options: ['', 'Monthly', 'Hourly', 'Project Based', 'Annual', 'Fixed'],
            required: true
          },
          { 
        ...
        [
          ...
          { 
            ...
            options: ['', 'Monthly', 'Bi-weekly', 'Weekly', 'Project Milestone', 'On Completion']
          },
          { 
      ...
      columns: [
        [
          { 
            ...
            options: ['', 'Online', 'In-person', 'Phone', 'Hybrid', 'Video Call'],
            required: true
          },
          { 
            ...
            placeholder: 'Enter interview process details, rounds, and schedule...',
            rows: 4
          },
        ],
        [
                ...
                <div key={colIndex} className="space-y-4">
                  {column.map((field, fieldIndex) => (
                    <div key={fieldIndex}>
                      <FormInput
                        {...field}
                        onChange={(value) => handleFieldChange(section.key, field.field, value)}
                      />
                    </div>
                  ))}
                </div>
